      ...
      <div className="container">
        <a href="/acceuil">
          <img
            ...
            alt=""
            src="https://i.imgur.com/Kcitezd.png"
          />
        </a>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
          <ul className="navbar-nav ml-auto">
            ...
            {isAuthenticated && (role === "organisator" || role === "admin") && (
              <li className="nav-item">
                <a className="nav-link">
                  <center className=" h-100" style={{backgroundColor:"transparent !important"}}>
                    <span style={{ color: "#D9534F" }}>Add Events</span>
                    <ModalEvent add={true} />
                  </center>
                </a>
              </li>
            ...
            <li className="nav-item">
              <a className="nav-link" href="/addMateriel">
                <div>
                <center>
                  <span>Materiels</span> <Avatar  className={classes.about}><AddIcon /></Avatar> 
                </center>
                </div>
              </a>
            </li>
